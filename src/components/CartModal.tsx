              ...
              <div className="flex flex-col gap-4 justify-between items-center w-full">
                <section className="flex gap-2 items-center justify-between w-full">
                  ...
                  <article className="flex flex-col text-DarkBlue-800">
                    ...
                    <p className="text-sm">
                      ${item.price}.00 x {item.count} <span className="font-bold text-DarkBlue-900">${item.nowPrice}.00</span>
                    </p>
                  </article>
                ...
                <button className="bg-Orange text-white font-semibold w-full h-12 rounded-lg">
                  Checkout
                </button>
              </div>
            ) : (
